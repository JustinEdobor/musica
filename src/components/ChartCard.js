...
const ChartCard = (props) => {
  return (
    <div className="fl">
       <div className="divide"><img src={props.imgsrc} alt="album cover" width="70px" height="70px"></img>
        ...
        <div className="like"><svg width="18" height="18" viewBox="0 0 18 18" fill="none" fill-opacity="0.25" xmlns="http://www.w3.org/2000/svg">
